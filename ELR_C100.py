...
parser.add_argument('--warmup_base', type=int, default=1, help='Number of sweeps over the dataset to train')
parser.add_argument('--warmup_reg', type=int, default=25, help='Number of sweeps over the dataset to train')
